Ext.define('Ext.cmp.cmp_pm_bundzettel.Viewport', {
    extend: 'Ext.tab.Panel',
    requires: [
      'Ext.cmp.cmp_pm_bundzettel.controller.Viewport',
      'Ext.cmp.cmp_pm_bundzettel.models.Viewport'
    ],

    controller: 'cmp_pm_bundzettel',
    viewModel: {
      type: 'cmp_pm_bundzettel'
    },
    listeners:{
      boxReady: 'onBoxReady'
    },
